...
/*
 ...
 PS:cell高度自适应前提>>应该调用cell的“- (void)setupAutoHeightWithBottomView:(UIView *)bottomView
 bottomMargin:(CGFloat)bottomMargin”方法进行cell的自动高度设置
 */
...
/** (不再推荐使用此方法！)开启高度自适应，建议在tableview的数据源方法“- (NSInteger)tableView:(UITableView *)tableView
 * numberOfRowsInSection:(NSInteger)section”中调用此方法*/
