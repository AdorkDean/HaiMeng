...
//    _videoCompressionSettings = [_videoDataOutput recommendedVideoSettingsForAssetWriterWithOutputFileType:AVFileTypeQuickTimeMovie];
    ...
    _videoCompressionSettings = @{AVVideoCodecKey : AVVideoCodecH264,AVVideoWidthKey : @(kScreenHeight*2),AVVideoHeightKey : @(kScreenWidth*2),AVVideoScalingModeKey:AVVideoScalingModeResizeAspectFill,};
//    _videoCompressionSettings = @{AVFormatIDKey:@(kAudioFormatMPEG4AAC),AVEncoderBitRateKey:@(64000),AVSampleRateKey:@(44100),AVNumberOfChannelsKey:@(1),};
}
